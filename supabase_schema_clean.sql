...
-- Drop all existing objects in correct order (reverse dependency order)
DROP POLICY IF EXISTS "refunds_select" ON public.refunds CASCADE;
DROP POLICY IF EXISTS "payments_select" ON public.payments CASCADE;
DROP POLICY IF EXISTS "reviews_select" ON public.course_reviews CASCADE;
DROP POLICY IF EXISTS "student_achievements_select" ON public.student_achievements CASCADE;
DROP POLICY IF EXISTS "certificates_select" ON public.certificates CASCADE;
DROP POLICY IF EXISTS "calendar_select" ON public.calendar_events CASCADE;
DROP POLICY IF EXISTS "categories_select" ON public.categories CASCADE;
DROP POLICY IF EXISTS "settings_select" ON public.platform_settings CASCADE;
DROP POLICY IF EXISTS "campaigns_select" ON public.marketing_campaigns CASCADE;
DROP POLICY IF EXISTS "audit_select" ON public.audit_logs CASCADE;
DROP POLICY IF EXISTS "achievements_select" ON public.achievements CASCADE;
